...
BEGIN
  ...
  -- Realistic calorie estimation per exercise category:
  -- aeróbico/cardio: ~10 kcal/min
  -- compound: ~6.5 kcal/min
  -- isolamento: ~4.5 kcal/min
  -- isométrico: ~3.5 kcal/min
  -- unknown: ~5.5 kcal/min (weighted average)
  SELECT
    COALESCE(SUM(
      GREATEST(
        CASE 
